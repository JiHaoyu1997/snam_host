// Generated by gencpp from file vpa_host/RobotInfo.msg
// DO NOT EDIT!


#ifndef VPA_HOST_MESSAGE_ROBOTINFO_H
#define VPA_HOST_MESSAGE_ROBOTINFO_H
...
struct RobotInfo_
{
  ...
  typedef boost::shared_ptr< ::vpa_host::RobotInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::vpa_host::RobotInfo_<ContainerAllocator> const> ConstPtr;

}; // struct RobotInfo_

typedef ::vpa_host::RobotInfo_<std::allocator<void> > RobotInfo;

typedef boost::shared_ptr< ::vpa_host::RobotInfo > RobotInfoPtr;
typedef boost::shared_ptr< ::vpa_host::RobotInfo const> RobotInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::vpa_host::RobotInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::vpa_host::RobotInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::vpa_host::RobotInfo_<ContainerAllocator1> & lhs, const ::vpa_host::RobotInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::vpa_host::RobotInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vpa_host::RobotInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::vpa_host::RobotInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::vpa_host::RobotInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vpa_host::RobotInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vpa_host::RobotInfo_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::vpa_host::RobotInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::vpa_host::RobotInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x11867948fae731e8ULL;
  static const uint64_t static_value2 = 0x2b48e6596c84aa31ULL;
};

template<class ContainerAllocator>
struct DataType< ::vpa_host::RobotInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::vpa_host::RobotInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::vpa_host::RobotInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::vpa_host::RobotInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vpa_host::RobotInfo_<ContainerAllocator>& v)
  {
    s << indent << "robot_name: ";
...
#endif // VPA_HOST_MESSAGE_ROBOTINFO_H
