...
"""autogenerated by genpy from vpa_host/InterMngRequest.msg. Do not edit."""
import codecs
import sys
...
class InterMngRequest(genpy.Message):
  ...
  _type = "vpa_host/InterMngRequest"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','int8','int8','vpa_host/RobotInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.robot_info is None:
        self.robot_info = vpa_host.msg.RobotInfo()
    else:
      self.header = std_msgs.msg.Header()
      self.robot_name = ''
      self.last_inter_id = 0
...
def _get_struct_b6f():
    ...
    return _struct_b6f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vpa_host/InterMngResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class InterMngResponse(genpy.Message):
  ...
  _type = "vpa_host/InterMngResponse"
