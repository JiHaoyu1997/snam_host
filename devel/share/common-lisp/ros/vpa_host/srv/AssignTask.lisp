...
(cl:defmethod cl:initialize-instance :after ((m <AssignTask-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AssignTask-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vpa_host-srv:<AssignTask-request> is deprecated: use vpa_host-srv:AssignTask-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <AssignTask-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AssignTask-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vpa_host-srv:<AssignTask-response> is deprecated: use vpa_host-srv:AssignTask-response instead.")))

(cl:ensure-generic-function 'task_list-val :lambda-list '(m))
(cl:defmethod task_list-val ((m <AssignTask-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-srv:task_list-val is deprecated.  Use vpa_host-srv:task_list instead.")
  (task_list m))
