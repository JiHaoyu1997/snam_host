...
(cl:defclass <InterMng-request> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (robot_info
    :reader robot_info
    :initarg :robot_info
    :type vpa_host-msg:RobotInfo
    :initform (cl:make-instance 'vpa_host-msg:RobotInfo)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <InterMng-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InterMng-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vpa_host-srv:<InterMng-request> is deprecated: use vpa_host-srv:InterMng-request instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <InterMng-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-srv:header-val is deprecated.  Use vpa_host-srv:header instead.")
  (header m))

(cl:ensure-generic-function 'robot_name-val :lambda-list '(m))
(cl:defmethod robot_name-val ((m <InterMng-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-srv:robot_name-val is deprecated.  Use vpa_host-srv:robot_name instead.")
  (robot_name m))

(cl:ensure-generic-function 'last_inter_id-val :lambda-list '(m))
(cl:defmethod last_inter_id-val ((m <InterMng-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-srv:last_inter_id-val is deprecated.  Use vpa_host-srv:last_inter_id instead.")
  (last_inter_id m))

(cl:ensure-generic-function 'curr_inter_id-val :lambda-list '(m))
(cl:defmethod curr_inter_id-val ((m <InterMng-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-srv:curr_inter_id-val is deprecated.  Use vpa_host-srv:curr_inter_id instead.")
  (curr_inter_id m))

(cl:ensure-generic-function 'robot_info-val :lambda-list '(m))
(cl:defmethod robot_info-val ((m <InterMng-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-srv:robot_info-val is deprecated.  Use vpa_host-srv:robot_info instead.")
  (robot_info m))
...
(cl:defmethod cl:initialize-instance :after ((m <InterMng-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InterMng-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vpa_host-srv:<InterMng-response> is deprecated: use vpa_host-srv:InterMng-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <InterMng-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-srv:success-val is deprecated.  Use vpa_host-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <InterMng-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-srv:message-val is deprecated.  Use vpa_host-srv:message instead.")
  (message m))
