...
(cl:defclass <InterInfo> (roslisp-msg-protocol:ros-message)
  ((inter_id
   ...
   (robot_info
    :reader robot_info
    :initarg :robot_info
    :type (cl:vector vpa_host-msg:RobotInfo)
   :initform (cl:make-array 0 :element-type 'vpa_host-msg:RobotInfo :initial-element (cl:make-instance 'vpa_host-msg:RobotInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <InterInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InterInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vpa_host-msg:<InterInfo> is deprecated: use vpa_host-msg:InterInfo instead.")))

(cl:ensure-generic-function 'inter_id-val :lambda-list '(m))
(cl:defmethod inter_id-val ((m <InterInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:inter_id-val is deprecated.  Use vpa_host-msg:inter_id instead.")
  (inter_id m))

(cl:ensure-generic-function 'robot_id_list-val :lambda-list '(m))
(cl:defmethod robot_id_list-val ((m <InterInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_id_list-val is deprecated.  Use vpa_host-msg:robot_id_list instead.")
  (robot_id_list m))

(cl:ensure-generic-function 'robot_info-val :lambda-list '(m))
(cl:defmethod robot_info-val ((m <InterInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_info-val is deprecated.  Use vpa_host-msg:robot_info instead.")
  (robot_info m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <InterInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'robot_info)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'vpa_host-msg:RobotInfo))
