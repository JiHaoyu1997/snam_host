...
(cl:defmethod cl:initialize-instance :after ((m <RobotInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vpa_host-msg:<RobotInfo> is deprecated: use vpa_host-msg:RobotInfo instead.")))

(cl:ensure-generic-function 'robot_name-val :lambda-list '(m))
(cl:defmethod robot_name-val ((m <RobotInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_name-val is deprecated.  Use vpa_host-msg:robot_name instead.")
  (robot_name m))

(cl:ensure-generic-function 'robot_id-val :lambda-list '(m))
(cl:defmethod robot_id-val ((m <RobotInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_id-val is deprecated.  Use vpa_host-msg:robot_id instead.")
  (robot_id m))

(cl:ensure-generic-function 'robot_a-val :lambda-list '(m))
(cl:defmethod robot_a-val ((m <RobotInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_a-val is deprecated.  Use vpa_host-msg:robot_a instead.")
  (robot_a m))

(cl:ensure-generic-function 'robot_v-val :lambda-list '(m))
(cl:defmethod robot_v-val ((m <RobotInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_v-val is deprecated.  Use vpa_host-msg:robot_v instead.")
  (robot_v m))

(cl:ensure-generic-function 'robot_p-val :lambda-list '(m))
(cl:defmethod robot_p-val ((m <RobotInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_p-val is deprecated.  Use vpa_host-msg:robot_p instead.")
  (robot_p m))

(cl:ensure-generic-function 'robot_enter_time-val :lambda-list '(m))
(cl:defmethod robot_enter_time-val ((m <RobotInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_enter_time-val is deprecated.  Use vpa_host-msg:robot_enter_time instead.")
  (robot_enter_time m))

(cl:ensure-generic-function 'robot_arrive_cp_time-val :lambda-list '(m))
(cl:defmethod robot_arrive_cp_time-val ((m <RobotInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_arrive_cp_time-val is deprecated.  Use vpa_host-msg:robot_arrive_cp_time instead.")
...
(cl:defmethod robot_exit_time-val ((m <RobotInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vpa_host-msg:robot_exit_time-val is deprecated.  Use vpa_host-msg:robot_exit_time instead.")
  (robot_exit_time m))
